insert into USERS_DB.role (name) values ('ADMINISTRATION');
insert into USERS_DB.role (name) values ('CONSULTANT');
insert into USERS_DB.role (name) values ('MANAGER');
insert into USERS_DB.department (department_guid,name) values ('14708cec-0315-415a-a0d3-17abe1d5df53','BANKING');
insert into USERS_DB.department (department_guid,name) values ('77065bda-b226-4b39-9092-94f48aaaa042','DIGITAL');
insert into USERS_DB.department (department_guid,name) values ('d31182ae-6dca-4153-83b1-fe949e5aade1','SALESFORCE');
